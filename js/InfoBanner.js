AFRAME.registerComponent("info-banner",{
  ...
  createBanner:function(){
    postersInfo = {
        "superman": {
            banner_url:"./assets/book/superman-banner.jpg",
            title:"Superman",
            released_year:"1983",
        ...
        "spiderman": {
            banner_url: "./assets/book/spiderman-banner.png",
            title: "Spiderman",
            released_year: "1962",
            description:
          ...
          "captain-aero": {
            banner_url: "./assets/book/captain-aero-banner.jpg",
            title: "Captain Aero",
            released_year: "1942",
            description:
          ...
          "outer-space": {
            banner_url: "./assets/book/outer-space-banner.jpg",
            title: "Outer Space",
            released_year: "1952",
            description:
